...
GOBUILD=CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/xiwangly2/tarumt-wifi-autoconnect/constant.Version=$(VERSION)" \
		-X "github.com/xiwangly2/tarumt-wifi-autoconnect/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
